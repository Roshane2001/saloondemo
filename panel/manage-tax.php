...
{
$id=intval($_GET['id']);
$query=mysqli_query($con,"delete from tbl_tax where id ='$id'");
    if ($query) {
     echo "<script>alert('Tax deleted.');</script>";
...
<body class="cbp-spmenu-push">
	<div class="main-content">
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="tables">
					<h3 class="title1">Manage Tax</h3>
					
					
				
					<div class="table-responsive bs-example widget-shadow">
						
						<table id="example" class="table table-bordered" > <thead> <tr> <th>#</th> <th>Tax Name</th> <th>Value</th><th>Action</th> </tr> </thead> <tbody>
<?php
...
?>
						 ...
						 <tr> <th scope="row"><?php echo $cnt;?></th> <td><?php  echo $row['name'];?></td> <td><?php  echo $row['value'];?></td></td> <td><a href="edit-tax.php?editid=<?php echo $row['id'];?>" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i></a> | 
<a href="manage-tax.php?action=delete&&id=<?php echo $row['id'];?>" class="btn btn-danger btn-sm"><i class="fa fa-trash-o" aria-hidden="true"></i></a>
