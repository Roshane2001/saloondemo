...
?>
                                ...
                                <tr>
                                    ...
                                    <td><a href="edit-staff.php?editid=<?php echo $row['id'];?>"
                                        ...
                                        <a href="manage-staff.php?action=delete&&id=<?php echo $row['id'];?>"
                                            class="btn btn-danger btn-sm"><i class="fa fa-trash-o"
                                                aria-hidden="true"></i></a>
                                        <!--<a href="#" class="btn btn-warning btn-sm" data-toggle="modal" data-target="#flipFlop"><i class="fa fa-plus" aria-hidden="true"></i></a>-->
