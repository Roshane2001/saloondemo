...
<html>
<head>
<title>Absent Appointments</title>
...
<body class="cbp-spmenu-push">
	<div class="main-content">
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="tables">
					<h3 class="title1">All Absent Appointments</h3>
					...
					<div class="table-responsive bs-example widget-shadow" style="margin-bottom: 30px;">
						<h4>Absent Appointments List:</h4>
						<table class="table table-bordered"> 
                            ...
                            <?php 
                                ...
                                echo '<tr><td colspan="9" class="text-center">No absent appointments found with the current filter.</td></tr>';
                            }
                            ?>
                            </tbody> 
                        </table> 
