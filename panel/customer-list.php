			...
			<div class="main-page">
				<div class="tables">
					...
					<div class="table-responsive bs-example widget-shadow">
						...
						<table id="example" class="table table-bordered"> <thead> <tr> <th>#</th> <th>Name</th> <th>Mobile</th><th>Action</th> </tr> </thead> <tbody>
<?php
...
?>
						 ...
						 <tr> <th scope="row"><?php echo $cnt;?></th> <td><?php  echo $row['Name'];?></td> <td><?php  echo $row['MobileNumber'];?></td> <td><a href="edit-customer-detailed.php?editid=<?php echo $row['ID'];?>" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i></a> |
						 <a href="customer-list.php?action=delete&&id=<?php echo $row['ID'];?>" class="btn btn-danger btn-sm"><i class="fa fa-trash-o" aria-hidden="true"></i></a>
						 <!--<a href="add-customer-services.php?addid=</?php echo $row['ID'];?>" class="btn btn-warning btn-sm">Assign Services</a>-->
