			...
			<div class="main-page">
				<div class="tables">
					...
					<div class="table-responsive bs-example widget-shadow">
						...
						<table id="example" class="table table-bordered" > <thead> <tr> <th>#</th> <th>Staff Name</th> <th>Service Count</th><th>Commission</th></tr> </thead> <tbody>
<?php
$ret=mysqli_query($con,"SELECT s.name, COUNT(i.staff) AS service_count, SUM(i.commision) AS total_commission
    FROM tblinvoice i
    JOIN tbl_staff s ON s.id = i.staff
    GROUP BY i.staff
    ORDER BY total_commission ASC ");
$cnt=1;
