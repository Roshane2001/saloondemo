...
if(isset($_POST['submit']))
  {
   ...
   $nic_no=$_POST['nic_no'];
    ...
    $query=mysqli_query($con, "insert into  tbl_staff(branch_id,name,contact,nic_no,email) value('$branch_id','$sername','$contact','$nic_no','$email')");
    if ($query) {
                            ...
                            <form method="post" class="row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="name" name="name"
                                        placeholder="Staff Name" value="" required="true">
                                </div>
                                <div class="form-group col-md-6"> <label>Email</label> <input type="email"
                                        class="form-control" name="email" id="email" placeholder="Email" rows="5"
                                        required="true"> </div>

                                <div class="form-group col-md-6"> <label>Contact</label> <input type="number"
                                        id="contact" name="contact" class="form-control" placeholder="Contact" value=""
                                        required="true"> </div>
                                <div class="form-group col-md-6"> <label>NIC No</label> <input type="text" id="nic_no"
                                        name="nic_no" class="form-control" placeholder="NIC No" value=""
                                        required="true"> </div>
