...
if(isset($_POST['submit']))
  {
    ...
    $query=mysqli_query($con, "insert into  tbl_category(name,status) value('$sername','$value')");
    if ($query) {
						...
						<div class="form-body">
							<form method="post" class="row">
							 ...
							 <div class="form-group col-md-6"> 
							 	<label> Name</label> 
							 	<input type="text" class="form-control" id="name" name="name" placeholder="Category Name" value="" required="true"> 
							 </div>
