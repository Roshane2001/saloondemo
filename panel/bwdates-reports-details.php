...
?>
                        <h5 align="center" style="color:blue">Report from <?php echo $fdate?> to <?php echo $tdate?>
                            (Branch: <?php echo $branch_name; ?>)</h5>
...
?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php if($row['type'] == 1): ?>
                                        <a href="view-receipt.php?invoiceid=<?php echo $row['BillingId'];?>"
                                            onclick="window.open(this.href, 'receipt', 'height=600,width=400'); return false;">View
                                            Receipt</a>
                                        <?php else: ?>
                                        <a href="view-receipt.php?invoiceid=<?php  echo $row['BillingId'];?>"
                                            onclick="window.open(this.href, 'receipt', 'height=600,width=400'); return false;">View
