...
{
$id=intval($_GET['id']);
$query=mysqli_query($con,"delete from membership_plans where ID='$id'");
    if ($query) {
...
<body class="cbp-spmenu-push">
	<div class="main-content">
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="tables">
					<h3 class="title1">Manage Plans</h3>
					
					
				
					<div class="table-responsive bs-example widget-shadow">
						
						<table id="example" class="table table-bordered" > <thead> <tr> <th>#</th> <th>Name</th> <th>Price</th><th>Duration</th><th>Action</th> </tr> </thead> <tbody>
<?php
$ret=mysqli_query($con,"select *from  membership_plans");
$cnt=1;
...
?>
						 ...
						 <td><a href="edit_plan.php?editid=<?php echo $row['id'];?>" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i></a> | 
<a href="manage_plan.php?action=delete&&id=<?php echo $row['id'];?>" class="btn btn-danger btn-sm"><i class="fa fa-trash-o" aria-hidden="true"></i></a> | 
