			...
			<div class="main-page">
				<div class="tables">
					...
					<div class="table-responsive bs-example widget-shadow">
						...
						<table id="example" class="table table-bordered"> <thead> 
							<tr> <th>#</th>
...
?>
						 ...
						 <tr> <th scope="row"><?php echo $cnt;?></th> <td><?php  echo $row['Email'];?></td> <td><?php  echo $row['DateofSub'];?></td>
						 	<td>
<a href="subcriber.php?action=delete&&id=<?php echo $row['ID'];?>" class="btn btn-danger"><i class="fa fa-trash-o" aria-hidden="true"></i></a>
</td>
						  </tr>   <?php 
$cnt=$cnt+1;
}?></tbody> </table> 
