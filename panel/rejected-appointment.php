			...
			<div class="main-page">
				<div class="tables">
					...
					<div class="table-responsive bs-example widget-shadow">
						...
						<table id="example" class="table table-bordered"> <thead> <tr> <th>#</th> <th> Appointment Number</th> <th>Name</th><th>Mobile Number</th> <th>Action</th> </tr> </thead> <tbody>
<?php
...
while ($row5=mysqli_fetch_array($ret5)) {
						...
						</td> <td><a href="view-appointment.php?viewid=<?php echo $row['ID'];?>">View</a></td> </tr>   <?php 
$cnt=$cnt+1;
}?></tbody> </table> 
					</div>
				</div>
