			...
			<div class="main-page">
				<div class="tables">
					...
					<div class="table-responsive bs-example widget-shadow">
						...
						<table id="example" class="table table-bordered" > <thead> <tr> <th>#</th> <th>Name</th> <th>Email</th><th>Total</th> </tr> </thead> <tbody>
<?php
...
?>
						 ...
						 <tr> <th scope="row"><?php echo $cnt;?></th> <td>
						     <?php 
...
while ($row5=mysqli_fetch_array($ret5)) {
						 ...
						 <td><?php  echo $row['total'];?></td></td> </tr>   <?php 
$cnt=$cnt+1;
}?></tbody> </table> 
					</div>
				</div>
