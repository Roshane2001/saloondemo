...
?>
						 ...
						 date('d-m-Y', strtotime($row['CreationDate']));?></td>
                                    <td><a href="edit-services.php?editid=<?php echo $row['ID'];?>"
                                        ...
                                        <?php if($row['type']==2){ ?>
                                            <?php if($row['status'] == 1): ?>
                                                <a href="manage-services.php?action=status_update&id=<?php echo $row['ID']; ?>&status=1" class="btn btn-success btn-sm" onclick="return confirm('Are you sure you want to deactivate this service?')">Active</a>
                                            <?php else: ?>
                                                <a href="manage-services.php?action=status_update&id=<?php echo $row['ID']; ?>&status=0" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to activate this service?')">Inactive</a>
                                            <?php endif; ?>
                                        <?php } ?>
