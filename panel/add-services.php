...
if(isset($_POST['submit']))
  {
   ...
   $cost=$_POST['cost'];
    ...
    $type=$_POST['type'];
    $ser_hours = isset($_POST['ser_hours']) ? intval($_POST['ser_hours']) : 0;
    ...
    if($image!="") {
        ...
        if(!in_array($extension,$allowed_extensions)) {
            ...
            $query=mysqli_query($con, "insert into  tblservices(ServiceName,Description,Cost,type,cate_id,Image,service_time) value('$sername','$des','$cost','$type','$cate_id','$newimage','$service_time')");
        }
    } else {
        $query=mysqli_query($con, "insert into  tblservices(ServiceName,Description,Cost,type,cate_id,service_time) value('$sername','$des','$cost','$type','$cate_id','$service_time')");
    }
...
?>
                                ...
                                <div class="form-group col-md-6"> <label>Cost</label> <input type="text" id="cost"
                                        name="cost" class="form-control" placeholder="Cost" value="" required="true">
                                </div>
                                <div class="form-group col-md-6"> <label>Image</label> <input type="file" id="image"
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="row">
                                        <div class="col-xs-6" style="padding-left: 0px;">
                                            <input type="number" name="ser_hours" class="form-control" placeholder="Hours" value="0" min="0">
                                        </div>
                                        <div class="col-xs-6" style="padding-left: 0px;">
                                            <input type="number" name="ser_minutes" class="form-control" placeholder="Minutes" value="0" min="0" max="59">
                                        </div>
                                    </div>
                                </div>
