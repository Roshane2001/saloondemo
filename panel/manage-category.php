...
{
$id=intval($_GET['id']);
$query=mysqli_query($con,"delete from tbl_category where id ='$id'");
    if ($query) {
			...
			<div class="main-page">
				<div class="tables">
					...
					<div class="table-responsive bs-example widget-shadow">
						...
						<table id="example" class="table table-bordered" > <thead> <tr> <th>#</th> <th>Category Name</th> <th>Status</th><th>Action</th> </tr> </thead> <tbody>
<?php
...
?>
						 ...
						 <tr> <th scope="row"><?php echo $cnt;?></th> <td><?php  echo $row['name'];?></td> <td><?php if($row['status']==1){echo 'Active'; }elseif($row['status']==2){ echo 'Deactive'; } ?></td></td> <td><a href="edit-category.php?editid=<?php echo $row['id'];?>" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i></a> | 
<a href="manage-category.php?action=delete&&id=<?php echo $row['id'];?>" class="btn btn-danger btn-sm"><i class="fa fa-trash-o" aria-hidden="true"></i></a>
